...
const Analysis = () => {
  ...
  const handleFileSelect = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      if (activeTab === "mammography" && isTiff) {
        try {
          ...
          setError("Failed to generate preview for TIFF image");
          setPreview(null);
        } finally {
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
              ...
              <div className="sharp-card">
                ...
                <label style={{ cursor: "pointer", display: "block" }}>
                  ...
                  <input type="file" style={{ display: "none" }} accept="image/*,.tif,.tiff" onChange={handleFileSelect} />
                </label>
              </div>
                ...
                <div className="sharp-card" style={{ animation: "fadeIn 0.3s ease" }}>
                  {previewLoading ? (
                    <div style={{ padding: "2rem", textAlign: "center" }}>
                      <Loader2 style={{ width: "32px", height: "32px", color: "#8b5cf6", animation: "spin 1s linear infinite", margin: "0 auto 1rem" }} />
