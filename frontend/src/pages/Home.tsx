            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "1.5rem", marginBottom: "2rem" }}>
              ...
              <div className="sharp-card" style={{ padding: "1.5rem", borderLeft: "3px solid #10b981" }}>
                <div style={{ display: "flex", alignItems: "center", gap: "1rem", marginBottom: "1rem" }}>
                  ...
                  <div>
                    <h3 style={{ color: "var(--color-text-primary)", fontWeight: 600, fontSize: "1.1rem" }}>Histopathology</h3>
                    <p style={{ color: "var(--color-text-secondary)", fontSize: "0.85rem" }}>Microscopic tissue analysis</p>
                  </div>
                </div>
                <div style={{ display: "flex", gap: "1rem", marginBottom: "1rem" }}>
                  ...
                  <div style={{ flex: 1, padding: "0.75rem", background: "rgba(6, 182, 212, 0.1)", borderRadius: "8px", textAlign: "center" }}>
                    ...
                    <div style={{ fontSize: "0.75rem", color: "var(--color-text-secondary)" }}>Images</div>
                  </div>
                </div>
              ...
              <div className="sharp-card" style={{ padding: "1.5rem", borderLeft: "3px solid #8b5cf6" }}>
                <div style={{ display: "flex", alignItems: "center", gap: "1rem", marginBottom: "1rem" }}>
                  ...
                  <div>
                    <h3 style={{ color: "var(--color-text-primary)", fontWeight: 600, fontSize: "1.1rem" }}>Mammography</h3>
                    <p style={{ color: "var(--color-text-secondary)", fontSize: "0.85rem" }}>BI-RADS classification</p>
                  </div>
                </div>
                <div style={{ display: "flex", gap: "1rem", marginBottom: "1rem" }}>
                  <div style={{ flex: 1, padding: "0.75rem", background: "rgba(139, 92, 246, 0.1)", borderRadius: "8px", textAlign: "center" }}>
                    <div style={{ fontSize: "1.5rem", fontWeight: 700, color: "#8b5cf6" }}>81.4%</div>
                    <div style={{ fontSize: "0.75rem", color: "var(--color-text-secondary)" }}>Accuracy</div>
                  </div>
                  <div style={{ flex: 1, padding: "0.75rem", background: "rgba(236, 72, 153, 0.1)", borderRadius: "8px", textAlign: "center" }}>
                    <div style={{ fontSize: "1.5rem", fontWeight: 700, color: "#ec4899" }}>3.2K</div>
                    <div style={{ fontSize: "0.75rem", color: "var(--color-text-secondary)" }}>Images</div>
                  </div>
                </div>
          ...
          {[
            ...
            <div key={feature.title} className="sharp-card" style={{ padding: "1.5rem" }}>
              <div style={{ display: "flex", alignItems: "flex-start", gap: "1rem" }}>
                ...
                <div>
                  <h3 style={{ color: "var(--color-text-primary)", fontWeight: 600, fontSize: "1.1rem", marginBottom: "0.5rem" }}>
                    {feature.title}
                  </h3>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "2rem" }} className="steps-grid">
            {[
              ...
              <div key={item.title} style={{ textAlign: "center" }}>
                ...
                <h4 style={{ color: "var(--color-text-primary)", fontSize: "1.25rem", fontWeight: 600, marginBottom: "0.5rem" }}>
                  {item.title}
                </h4>
                <p style={{ color: "var(--color-text-secondary)", margin: 0 }}>{item.desc}</p>
              </div>
            ))}
          </div>
        </div>
